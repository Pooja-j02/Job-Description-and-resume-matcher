...
from settings import Config  # Import configuration settings from settings.py

app = Flask(__name__)
app.config.from_object(Config)  # Load settings from the Config class in settings.py
...
if __name__ == '__main__':
    ...
    # Run the app using the host and port from settings.py
